...
## Content
### CustomerManagementSystem.Analyzers
...
### CustomerManagementSystem.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [CustomerManagementSystem.Analyzers.Sample.csproj](../CustomerManagementSystem.Analyzers.Sample/CustomerManagementSystem.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### CustomerManagementSystem.Analyzers.Tests
