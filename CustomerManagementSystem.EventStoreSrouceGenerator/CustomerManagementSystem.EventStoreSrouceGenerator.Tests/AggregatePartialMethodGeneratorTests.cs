...
public class AggregatePartialMethodGeneratorTests
{
    ...
    [Fact]
    public void GeneratePartialMethod_For_Apply_Method_When_NamespaceIsFileScoped_For_Cass_Events()
    {
        //lang=csharp
        const string sourceTextWithFileScopedNamespace = """
                                                         namespace CustomerManagementSystem.Api.Endpoints;
                                                         ...
                                                         internal class EmailUpdated(Guid CustomerId, string Email) : IEvent<Customer>
                                                         {
                                                         }
                                                         """;
        //lang=csharp
